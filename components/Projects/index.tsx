...
const projects = {
    ...
    'python-CLI':{
        ...
        'description':'Currently in development, the MusiCLI project is my most recent endeavor. At its core, MusiCLI is a dynamic Command Line Interface (CLI) that facilitates the seamless import of playlists from both Spotify and Apple Music platforms. By simplifying the import process, I aim to optimize operational efficiency while simultaneously alleviating the burden of doing the work manually. In a bid to further enhance user experience, I have automated the conversion of the imported data into universally compatible Excel or CSV formats. This transformation not only adds an element of user convenience but also opens doors to effortless data analysis and a myriad of applications. One of the hallmark features of MusiCLI lies in its dual functionality, affording users the flexibility to upload their own Excel/CSV files, thereby enabling the creation or augmentation of playlists with ease. This feature underscores the project\'s commitment to offering a user-friendly and adaptable approach to music management. The MusiCLI project is developed using Python, along with the Spotify API and the Apple Music API.',
    },
    'misa-website':{
        'name':'MISA Website',
        'when':'July 2023',
